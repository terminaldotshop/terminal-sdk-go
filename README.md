...
The Terminal Go library provides convenient access to the [Terminal REST API](https://terminal.shop/docs)
...
```sh
go get -u 'github.com/terminaldotshop/terminal-sdk-go@v1.14.0'
```
