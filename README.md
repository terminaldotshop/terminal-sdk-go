...
API](https://terminal.shop/docs) from applications written in Go. The full API of this library can be found in [api.md](api.md).
...
```sh
go get -u 'github.com/terminaldotshop/terminal-sdk-go@v0.1.0-alpha.61'
```
